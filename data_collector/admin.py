...
class NewsSourceAdmin(admin.ModelAdmin):
    ...
    # 필드 그룹화 (상세 페이지)
    fieldsets = (
        ("기본 정보", {"fields": ("publisher", "category", "url", "source_type")}),
        ("수집 설정", {"fields": ("is_active", "collection_interval")}),
        (
            "수집 정보",
            {
...
class NewsArticleAdmin(admin.ModelAdmin):
    ...
    # 필드 그룹화
    fieldsets = (
        ("기본 정보", {"fields": ("source", "title", "url", "category")}),
        ("내용", {"fields": ("description", "author")}),
        ("시간 정보", {"fields": ("published_at", "collected_at")}),
        ("상태", {"fields": ("is_processed",)}),
    )
...
class DataCollectionJobAdmin(admin.ModelAdmin):
    ...
    # 필드 그룹화
    fieldsets = (
        ("작업 정보", {"fields": ("source", "status", "items_collected")}),
        ("시간 정보", {"fields": ("started_at", "completed_at")}),
        ("에러 정보", {"fields": ("error_message",), "classes": ("collapse",)}),
    )
...
class CollectionSessionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("메모", {"fields": ("notes",), "classes": ("collapse",)}),
    )
